...
| — | Verificación independiente de T5 (Juan Pablo), con dos correcciones | [`docs/T5_verificacion.md`](docs/T5_verificacion.md) |
| — | Verificación independiente de T5 en Windows (Lina), hallazgo de Python 3.14 | [`docs/T5_verificacion_lina.md`](docs/T5_verificacion_lina.md) |
...
| — | Verificación independiente de T6 en Windows (Lina) | [`docs/T6_verificacion_lina.md`](docs/T6_verificacion_lina.md) |
