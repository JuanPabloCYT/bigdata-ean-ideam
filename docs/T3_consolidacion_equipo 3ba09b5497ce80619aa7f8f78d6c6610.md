# T3_consolidacion_equipo

Fecha: 12 de agosto de 2026 15:43
...
|  | **A · Precipitación IDEAM** | **B · *(por definir)*** | **C · *(por definir)*** |
| --- | --- | --- | --- |
| **Integrante** | Juan Pablo Castro | Camilo Rojas  |  |
| **Conjunto** | `s54a-sgyg`, Datos Abiertos | `p6dx-8zbt`, Datos Abiertos Colombia |  |
...
| **4. Formato y esquema** | CSV sin comprimir, 12 columnas, estable entre dos días completos | **CSV sin comprimir, 59 columnas**, esquema estable entre los dos períodos comparados |  |
...
| Repositorio T2 | [https://github.com/JuanPabloCYT/bigdata-ean-ideam](https://github.com/JuanPabloCYT/bigdata-ean-ideam) |  |  |
...
**Repositorio consolidado:** *(por definir)*

Si la fuente elegida es la A, el repositorio base es [https://github.com/JuanPabloCYT/bigdata-ean-ideam](https://github.com/JuanPabloCYT/bigdata-ean-ideam), que ya contiene el entorno reproducible de T2, la ficha T1 versionada, la práctica del clúster y la proyección. Los otros dos integrantes se añaden como colaboradores con permiso de escritura.
